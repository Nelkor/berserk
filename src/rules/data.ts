...
const rawRules: RawRulesChapter[] = [
  {
    ...
    items: [
      ...
      {
        code: '106.1',
        text: 'Тип карты — определяется символом типа в правом верхнем углу карты. Существуют типы карт: «Герой», «Существо», «Карта поддержки», «Заклинание». Для трёх классов карт Поддержки — «Амулет», «Броня», «Оружие» — используются собственные символы. Принадлежность карты к тому или иному типу определяют его базовые свойства.',
        keywords: [],
      },
      {
        code: '106.1.1',
