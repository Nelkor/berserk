...
export const GREETINGS =
  'Привет, рад знакомству! Нажми /help и расскажу, что умею, подробнее.'
...
export const HELP = [
  [
    '<b>Инструкция</b>\n\nККИ «Берсерк. Герои», полные правила',
    '(девятая базовая редакция). Ты задаёшь мне ключевую фразу,',
    'я ищу, в каком пункте правил она встречается.\n',
  ].join(' '),
  ...
  [
    'По любым вопросам, найденным багам,',
    'опечаткам и неточностям пиши @nelkor.',
  ].join(' '),
].join('\n')
